...
export const projects = [
  {
    ...
    icon: "🤖",
    description: "Built a sophisticated conversational AI platform with real-time document processing capabilities",
    techStack: ["React", "Tailwind CSS", "Chart.js", "PDF APIs", "Node.js"],
    features: [
  ...
  },
  {
    ...
    icon: "💳",
    description: "Full B2C platform with user management and payment gateway integration",
    techStack: ["Next.js", "Tailwind CSS", "Recharts", "Stripe", "Node.js"],
    features: [
  ...
  },
  {
    ...
    icon: "🗺️",
    description: "Interactive map-based dashboards with performance-optimized architecture",
    techStack: ["Next.js", "Azure Maps", "Redux", "TypeScript", "Azure DevOps"],
    features: [
      "Interactive map-based dashboards",
      "Performance-optimized architecture",
      "Cost-efficient cloud integration",
  ...
  },
  {
    ...
    icon: "📊",
    description: "5+ scalable business solutions with complex data visualization",
    techStack: ["Next.js", "Material UI", "Redux", "TypeScript", "Python"],
    features: [
  ...
  },
  {
    ...
    icon: "⚙️",
    description: "API integrations and backend services using Node.js and Python as needed",
    techStack: ["Node.js", "Python", "REST APIs", "Express.js"],
    features: [
      "RESTful API integration",
      "Third-party service connections",
      "Data processing scripts",
      "Backend support as required",
    ],
    impact: [
