  ...
  return (
    <section className="py-16 sm:py-20 md:py-24 relative">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-3 sm:mb-4 bg-gradient-to-r from-blue-400 via-cyan-400 to-indigo-400 bg-clip-text text-transparent px-2">
            Technical Expertise
          </h2>
            ...
            >
              ...
              <div className="relative p-6 sm:p-8 glass-effect rounded-2xl sm:rounded-3xl shadow-xl hover:shadow-2xl transition-all">
                <div className="flex items-center gap-3 sm:gap-4 mb-5 sm:mb-6">
                  ...
                  <h3 className="text-xl sm:text-2xl font-black text-white">{category.title}</h3>
                </div>
                  ...
                  {category.skills.map((skill, idx) => (
                    <div key={idx}>
                      <div className="flex justify-between items-center mb-2">
                        <span className="text-sm sm:text-base text-gray-100 font-bold">{skill.name}</span>
